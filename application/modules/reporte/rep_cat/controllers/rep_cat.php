...
class Rep_CAT extends MX_Controller {

    public function __construct()
    {
        parent::__construct();
        $this->load->model('m_rep_cat', 'model');
    }
    ...
    public function index() {
        ...
        $data['p_cat_desc'] = $this->input->get('cat_desc'); 
        ...
        $this->load->view('v_rep_cat', $data);
    }
    public function getView() {
        $data['p_cat_id'] = $this->input->get('cat_id'); 

        $data['doc'] = $this->model->get_doc_row($data['p_cat_id']);
        $data['doc_requisito_list'] = $this->model->get_doc_requisito_list($data['p_cat_id']);
        $data['doc_estado_list'] = $this->model->get_doc_estado_list($data['p_cat_id']);
        $data['vehiculo_list'] = $this->model->get_vehiculo_list($data['p_cat_id']);
       
        $this->load->view('v_rep_cat_view', $data);
    }
