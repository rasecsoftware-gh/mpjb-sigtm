...
?>
	...
	<table class="report-document-table">
		<tr>
			...
			<td>
<?php  echo $doc->psp_anio.' - '.str_pad($doc->psp_numero, 4, '0', STR_PAD_LEFT); ?>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<th>Tipo Permiso:</th>
			<td><?=$doc->tipo_permiso_desc?></td>
		</tr>
		<tr>
			<th>Fecha de Inicio:</th>
			<td><?=$doc->psp_fecha_inicio?></td>
		</tr>
		<tr>
			<th>Fecha de Termino:</th>
			<td><?=$doc->psp_fecha_fin?></td>
		</tr>
		<tr>
			<th>Ruta:</th>
			<td><?=$doc->psp_ruta?></td>
	...
	?>
			<tr>
				<td title="<?=$r->psp_vehiculo_id?>"><?=$nr?></td>
				<td><?=$r->psp_vehiculo_categoria?></td>
				<td><?=$r->psp_vehiculo_marca?></td>
				<td><?=$r->psp_vehiculo_modelo?></td>
				<td><?=$r->psp_vehiculo_color?></td>
				<td><?=$r->psp_vehiculo_placa?></td>
				<td><?=$r->psp_vehiculo_ntp?></td>
				<td><?=$r->psp_vehiculo_conductor_nomape?></td>
				<td><?=$r->psp_vehiculo_conductor_dni?></td>
				<td><?=$r->psp_vehiculo_conductor_nlc?></td>
			</tr>
	<?php
		}
	?>
