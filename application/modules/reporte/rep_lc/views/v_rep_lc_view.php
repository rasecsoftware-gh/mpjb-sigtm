...
?>
	...
	<table class="report-document-table">
		<tr>
			...
			<td>
<?php  echo $doc->lc_anio.' - '.str_pad($doc->lc_numero, 4, '0', STR_PAD_LEFT); ?>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<th>Categoria:</th>
			<td><?=$doc->lc_categoria?></td>
		</tr>
		<tr>
			<th>Resolucion:</th>
			<td><?=$doc->lc_resolucion?></td>
		</tr>
		<tr>
			<th>Res. Fecha:</th>
			<td><?=$doc->lc_resolucion_fecha?></td>
		</tr>
		<tr>
			<th>Fecha de Expedicion:</th>
			<td><?=$doc->lc_fecha_exp?></td>
		</tr>
		<tr>
			<th>Fecha de Vencimiento:</th>
			<td><?=$doc->lc_fecha_ven?></td>
		</tr>
		<tr>
			<th>Restriccion:</th>
			<td><?=$doc->lc_restricciones?></td>
		</tr>
		<tr>
