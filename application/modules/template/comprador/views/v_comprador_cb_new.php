...
comprador.window_comprador_cb_new = function(id_comprador) {
		...
		var w_detail_config = {
			...
			items:[{
				...
				items:[{
					xtype: 'hiddenfield', name: 'id_comprador', value: id_comprador
				},{
					fieldLabel:'Banco:',
					xtype: 'combobox',
		...
		var store = Ext.create("Ext.data.Store", {
			proxy: {
				type:'ajax',
				url:'comprador/getNewCompradorCBRow',
				reader:{
					type:'json',
					rootProperty:'data'
				}
