<script>
	cat.doc_estado_add_window = function(record) { // doc_estado record
		...
		var w_config = {
			...
			items:[{
				xtype: 'form', 
				url: 'cat/addDocEstado',
				bodyPadding: 10,
				region: 'center',
				layout: 'absolute',
				id: 'cat_doc_estado_form',
				...
				items:[{
					...
					id: 'cat_doc_estado_form_estado_doc_desc_field',
					xtype: 'displayfield',
					fieldLabel: 'Estado',
					...
					id: 'cat_doc_estado_form_doc_estado_fecha_field',
					xtype: 'datefield',
					fieldLabel: 'Fecha',
			...
			buttons:[{
				text: 'Guardar', handler: function() {
					var frm = Ext.getCmp('cat_doc_estado_form');
					frm.submit({
						success: function(form, action) {
							if (action.result.success) {
								Ext.getCmp('cat_doc_estado_add_window').close();
								cat.reload_list(doc_id);
							} else {
			...
			listeners: {
				show: function () {					
					//Ext.getCmp('cat_cancelar_emitido_form').loadRecord(record);
				}
			}
		};
